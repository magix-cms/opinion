...
<head>
    ...
    <style>
        ...
        .header p { color: {$getDataCSSIColor[1].color_cssi}; margin-bottom: 0; }
        .header .wrapper-inner { padding: 0; }
        .header .container { background: {$getDataCSSIColor[0].color_cssi}; }
        .header .container td { padding: 15px; }
        .spacer.spacer-hr td{ border-top: 1px solid #eeeeee; }
    </style>
</head>
<body>
<!-- <style> -->
                                ...
                                <tr>
                                    <td valign="middle">
                                        ...
                                        <a href="{geturl}" target ="_blank" title="{$companyData.name}" style="text-decoration: none;font-size: 46px;">
                                            <img src="{geturl}/skin/{template}/img/logo/{#logo_img_mail#}" alt="{#logo_img_alt#|ucfirst}" width="306" height="68"/>
                                        </a>
                                    </td>
                                </tr>
                                </tbody>
